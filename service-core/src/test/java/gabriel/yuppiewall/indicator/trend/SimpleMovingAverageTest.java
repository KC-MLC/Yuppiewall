...
public class SimpleMovingAverageTest {
	...
	public void test2day() {
		...
		for (int i = 0; i < historical.length; i++) {
			historical[i] = new EndOfDayData(new Instrument(), new Date(),
					new BigDecimal(0L), new BigDecimal(0L), new BigDecimal(i),
					new BigDecimal(0L), new BigDecimal("0"), new BigDecimal(0L));

		}

		TechnicalIndicatorOutput[] sma = null;/*
											 * new
											 * SimpleMovingAverage().calculate(
											 * historical, 2);
											 */
