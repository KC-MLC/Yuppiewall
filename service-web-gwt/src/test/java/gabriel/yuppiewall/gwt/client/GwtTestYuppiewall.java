 ...
 * details.
 */
public class GwtTestYuppiewall extends GWTTestCase {

	/**
	 * Must refer to a valid module that sources this class.
	 */
	public String getModuleName() {
		return "gabriel.yuppiewall.gwt.YuppiewallJUnit";
	}
	...
	public void testGreetingService() {
		...
		PingServiceAsync pingService = GWT.create(PingService.class);
		ServiceDefTarget target = (ServiceDefTarget) pingService;
		target.setServiceEntryPoint(GWT.getModuleBaseURL() + "Yuppiewall/ping");
		...
		pingService.ping("test", new AsyncCallback<String>() {
